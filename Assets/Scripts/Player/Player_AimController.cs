...
public class Player_AimController : MonoBehaviour
{
    ...
    private void UpdateAimPosition()
    {
        ...
        {
            // Đẩy aim point ra cách xa hơn
            Vector3 directionFromPlayerToAim = (aim.position - transform.position).normalized;
            aim.position = transform.position + directionFromPlayerToAim * minAimDistance;
        }
