...
public class Footsteps_Visuals : MonoBehaviour
{
    ...
    {
        Vector3 checkPosititon = foot.transform.position + Vector3.down * rayDistance;

        bool touchingGround = Physics.CheckSphere(checkPosititon, checkRadius, whatIsGround);
    ...
    private void DrawFootGizmos(Transform foot)
    {
        ...
        Vector3 checkPosititon = foot.position + Vector3.down * rayDistance;

        Gizmos.DrawWireSphere(checkPosititon, checkRadius);
    }
}
