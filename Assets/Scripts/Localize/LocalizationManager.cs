...
public class LocalizationManager : MonoBehaviour
{
    ...
    // 🔥 Property để Editor lấy danh sách key
    public List<LocalizationEntry> AllLocalizations => allLocalizations;
    ...
    public static string GetLocalizedValue(string key)
    {
        ...
        // Handle case where LocalizationManager hasn't been initialized yet
        if (instance == null)
        {
            Debug.LogWarning($"[Localization] LocalizationManager instance not found. Returning key: {key}");
